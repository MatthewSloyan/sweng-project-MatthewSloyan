...
recipes = [
    {
        ...
        :steps => ['Heat grill to medium and line the grill pan with foil.', 'Beat the egg white on a plate with a little salt and pepper.', 'Dip the chicken first in egg white, then in the cheese.', 
            'Grill the coated chicken for 10-12 mins.', 'Boil the potatoes for 10 mins.', 'Divide between four warm plates, then serve with the chicken.'],
        :ingredients => ['1 egg white', '5 tbsp grated parmesan', '4 boneless chicken breasts', '400g new potatoes'],
        :author => 'Matthew_S'
    },
    {
