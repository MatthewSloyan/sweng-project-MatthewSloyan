...
# Cocoon gem to create nested forms
...
group :development, :test do
  ...
  gem 'cucumber-rails-training-wheels'  # commonly used step definitions for browser interaction
  ...
  gem 'simplecov', :require => false # measures test coverage
